        ...
        {bookings?.length > 0 ? (
          bookings.map((booking) => (
            <Link
              ...
              className="mx-4 my-8 flex h-28 gap-4 overflow-hidden rounded-2xl glass-card md:h-40 lg:mx-0"
              key={booking._id}
            >
              ...
              <div className="grow py-3 pr-3">
                ...
                <div className="md:text-xl">
                  ...
                  <div className="md:text-xl">
                    <BookingDates
                      booking={booking}
                      className="mb-2 mt-4 hidden items-center text-muted-foreground  md:flex"
                    />
