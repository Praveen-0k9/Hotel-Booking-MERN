    ...
    <div>
      ...
      {booking?.place ? (
        <div className="p-4">
          ...
          />
          <div className="my-6 flex flex-col items-center justify-between rounded-2xl bg-muted p-6 sm:flex-row">
            <div className=" ">
            ...
            <div className="mt-5 w-full rounded-2xl bg-primary p-6 text-primary-foreground sm:mt-0 sm:w-auto">
