...
const PlacePage = () => {
  ...
  return (
    <div className="mt-0 overflow-x-hidden px-8 pt-8 ">
      ...
      <div className="-mx-8 border-t border-border bg-card px-8 py-8 transition-colors">
        <div>
          <h2 className="mt-4 text-2xl font-semibold">Extra Info</h2>
        </div>
        <div className="mb-4 mt-2 text-sm leading-5 text-muted-foreground">
          {place.extraInfo}
        </div>
      </div>
    </div>
