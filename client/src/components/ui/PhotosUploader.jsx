  ...
  return (
    <>
      <div className="flex gap-2">
        ...
        />
        <button
          className="rounded-2xl bg-secondary text-secondary-foreground px-4 py-2 font-medium hover:bg-secondary/80 transition-colors"
      ...
      <div className="mt-2 grid grid-cols-3 gap-2 md:grid-cols-4 lg:grid-cols-6 ">
        ...
        <label className="flex h-32 cursor-pointer items-center justify-center gap-1 rounded-2xl border border-input bg-transparent p-2 text-2xl text-muted-foreground hover:border-primary hover:text-primary transition-colors">
          <input
            type="file"
            multiple
            className="hidden"
