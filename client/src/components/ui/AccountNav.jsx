...
const AccountNav = () => {
  ...
  const linkClases = (type = null) => {
    let classes =
      'flex justify-center mx-10 md:mx-0 gap-1 py-2 px-6 rounded-full transition-colors duration-200';
    if (type === subpage) {
      classes += ' bg-primary text-primary-foreground shadow-lg shadow-primary/25';
    } else {
      classes += ' bg-muted text-muted-foreground hover:bg-muted/80 hover:text-foreground';
    }
    return classes;
  };
  return (
