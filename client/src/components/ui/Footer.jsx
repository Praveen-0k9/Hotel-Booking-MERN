...
const Footer = () => {
  return (
    <div className="flex  w-full justify-center bg-muted pb-8 border-t border-border">
      <div className="flex w-full max-w-screen-xl flex-col items-center px-6">
        ...
        <div className="my-4 w-full border-[1px] border-border"></div>
        ...
        <div className="flex w-full flex-col items-center justify-between gap-4 md:gap-0 lg:flex-row">
          <div className="mt-4 flex w-full justify-between gap-10 md:order-last md:w-auto">
            ...
            <div className="flex gap-3">
              ...
              <svg
                xmlns="http://www.w3.org/2000/svg"
                className="h-6 w-6 cursor-pointer fill-foreground"
                viewBox="0 0 50 50"
              >
          ...
          <div className="flex w-full flex-col gap-2 px-1 font-normal text-muted-foreground md:w-auto md:flex-row md:items-center md:gap-8">
            ...
            <div>
              <ul className=" flex gap-6 text-sm text-muted-foreground">
                ...
                <li className="cursor-pointer list-disc text-muted-foreground decoration-1 underline-offset-1 hover:underline">
                  Terms
                </li>
                <li className="cursor-pointer list-disc text-muted-foreground decoration-1 underline-offset-1 hover:underline">
                  Sitemap
